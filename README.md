...
A [shadcn](https://ui.shadcn.com)-compatible component registry — 76 React + Tailwind components and variants, installable straight into any project via the shadcn CLI.
